...
namespace StudentManagementSystem.Controllers
{
    public class CourseTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Course_Name")] CourseTable courseTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Course_Name")] CourseTable courseTable)
        {
            if (ModelState.IsValid)
            {
